...
import hi.json.utils.FileUtils;
...
public class MainView extends FrameView {
    ...
    public MainView(SingleFrameApplication app, String... args) {
        super(app);
        ...
        if (args != null) {
            for (String arg : args) {
                ...
                if (file.exists()) {
                    String read = FileUtils.readToString(arg);

                    JTextArea ta = getTextArea();
                    if (ta != null) {
                        ta.setText(read.replaceAll("\n", ""));
                    }
                }
    ...
    private void initUI() {
        ...
        Image ico = new ImageIcon(getClass().getResource("/json.ico")).getImage();
    ...
    private JToolBar createToolBar() {
        ...
        JButton btnAppTitle = new JButton(resourceMap.getString("editTitle.txt"));
        JButton btnFormat = new JButton(resourceMap.getString("menuItemFormat.txt"));
        JButton btnClean = new JButton(resourceMap.getString("menuItemClean.txt"));
        JButton btnParse = new JButton(resourceMap.getString("mtPaste.text"));
        JButton btnNewLine = new JButton(resourceMap.getString("mtClean.text"));
        JButton btnXG = new JButton(resourceMap.getString("mtClean.text"));
        JButton btnTxtFind = new JButton(resourceMap.getString("selectContext.text"));
        JButton btnNodeFind = new JButton(resourceMap.getString("nodeContext.text"));
        JButton btnNewTab = new JButton(resourceMap.getString("menuItemNew.text"));
        JButton btnSelTabName = new JButton(resourceMap.getString("renameItem.text"));
        JButton btnCloseTab = new JButton(resourceMap.getString("closeItem.text"));
        ...
        btnSelTabName.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selIndex >= 0) {
                    ...
                    logger.info("Modify HashCode : " + getTree(selIndex).hashCode() + " . TabTitle : " + textField.getText() + " !");
                }
            }
        });
    ...
    private void initTabbedContainer() {
        ...
        tabDataModel.addComplexListDataListener(new ComplexListDataListener() {
            private ComplexListDataEvent clde;
            ...
            public void intervalRemoved(ListDataEvent e) {
                ...
                if (tbArr != null && tbArr.length > 0) {
                    ...
                    if (tree != null) {
                        ...
                        logger.info("Remove HashCode: " + tree.hashCode() + ". Close Tab: " + tbArr[0].getText() + " !");
                    }
                }
            }
        ...
        tabbedContainer.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                //logger.info("@@@:TabbedContainerActionCommand = "+e.getActionCommand());
...
//      scheme.getStyle(Token.DATA_TYPE).foreground = Color.blue;
    ...
    private JTree newTree() {
        ...
        logger.info("New HashCode : " + tree.hashCode());
        return tree;
    }
    ...
    private void treeSelection(JTree tree, JTable table) {
        ...
        if (selNode == null) {
            //logger.info("jTree1ValueChanged:selNode is null");
            return;
        }
        String col[] = {"key", "value"};
    ...
    private void formatJson() {
        ...
        //创建树节点
        JTree tree = getTree();
        logger.info("Put HashCode : " + tree.hashCode() + " . TabTitle : " + getTabTitle() + " !");
...
//        return treePathLst;
    ...
    private class TreeNodeMenuItemActionListener implements ActionListener {
        ...
        private String copyNodeContent(String path, boolean isFormat) {
            ...
            logger.info("Get HashCode : " + tree.hashCode() + " . TabTitle : " + getTabTitle());
